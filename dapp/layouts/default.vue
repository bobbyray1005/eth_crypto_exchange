    ...
    >
      <v-toolbar-title>
        <nuxt-link style="text-decoration: none" to="/">
          <img
            src="https://shopping.io/wp-content/uploads/2020/09/logo-shopping.png"
            class="logo-img"
            style="height: 30px"
            alt="shopping.io logo"
          />
        </nuxt-link>
      </v-toolbar-title>
      <div class="flex-grow-1"></div>
      <v-btn href="https://twitter.com/shopping_io" target="_blank" fab text>
      ...
      <v-btn
        text
        fab
        @click="goToExternalUrl('https://t.me/joinchat/F8pi_g-SvCtqaLq7hOr2yw')"
      >
  ...
  methods: {
    async rpcProviderInit() {
      ...
      if (chainId === 1 || chainId === 56) {
        console.log('connected to mainnet or bnb mainnet')
      } else {
